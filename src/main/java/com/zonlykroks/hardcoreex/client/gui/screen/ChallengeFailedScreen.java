...
//    private final ITextComponent failedCause;
    ...
    public ChallengeFailedScreen(@Nullable Challenge challenge) {
        super(challenge == null ? new TranslatableComponent("hardcoreex.failed_challenge.died") : new TranslatableComponent("hardcoreex.failed_challenge.title", challenge.getDescription()));
...
//        this.failedCause = new TranslationTextComponent("hardcoreex.failed_challenge.message");
    ...
    protected void init() {
        ...
        if (narratorStatus == NarratorStatus.SYSTEM || narratorStatus == NarratorStatus.ALL) {
            ...
            Narrator.getNarrator().say("You failed the " + challenge.getDescription() + " challenge!", true);
        }
        ...
        Button button = this.addRenderableWidget(new Button(this.width / 2 - 100, this.height / 4 + 72, 200, 20, new TranslatableComponent("deathScreen.spectate"), (p_213021_1_) -> {
        ...
        button.active = true;
        Button button1 = this.addRenderableWidget(new Button(this.width / 2 - 100, this.height / 4 + 96, 200, 20, new TranslatableComponent("hardcoreex.failed_challenge.delete"), (p_213020_1_) -> {
            // Delete world.
     ...
     *
     * @param poseStack    the {@link PoseStack matrix stack}.
    ...
    public void render(@NotNull PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.fillGradient(poseStack, 0, 0, this.width, this.height, 0x60500000, 0xa0803030);
        ...
        drawCenteredString(poseStack, this.font, this.scoreText, this.width / 2, 100, 16777215);
