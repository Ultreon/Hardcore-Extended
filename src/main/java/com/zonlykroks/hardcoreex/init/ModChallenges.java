...
public class ModChallenges {
    ...
    public static final RegistryObject<NonViolent> NO_ATTACK = CHALLENGES.register("no_attack", NonViolent::new);
    public static final RegistryObject<InstaDeathChallenge> NO_DAMAGE = CHALLENGES.register("no_damage", InstaDeathChallenge::new);
    ...
    public static final RegistryObject<UnbreakableBlocksChallenge> NO_BLOCK_BREAKING = CHALLENGES.register("no_block_breaking", UnbreakableBlocksChallenge::new);
    ...
    public static final RegistryObject<TNTDropsOnYouChallenge> TNT_RAIN = CHALLENGES.register("tnt_rain", TNTDropsOnYouChallenge::new);
